...
train_dataset = DataLoader(dataset=WSJDataset(sentences[:2700]), batch_size=64, shuffle=True)
test_dataset = DataLoader(dataset=WSJDataset(sentences[2701:3700]), batch_size=64, shuffle=True)
